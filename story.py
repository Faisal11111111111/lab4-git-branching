...
def right_path():
    ...
    print("You accept its offer, and slowly, darkness consumes your soul...")
    print("With your new dark powers, you overthrow the forest guardians and reign with terror.")
